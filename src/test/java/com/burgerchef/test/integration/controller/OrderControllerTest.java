package com.burgerchef.test.integration.controller;
...
import com.burgerchef.repository.OrderRepository;
import com.burgerchef.test.integration.controller.util.OrderControllerTestUtils;
import com.burgerchef.test.util.OrderTestUtils;
...
import com.burgerchef.domain.Order;
...
public class OrderControllerTest extends ControllerIntegrationTest {
    ...
    public void testCreateNewOrderEnsureOrderCreated() throws Exception {
    	assertNoOrders();
    	Order desiredOrder = OrderTestUtils.generateTestOrder();
    	createOrder(toJsonString(desiredOrder));
    	assertOrderCountIs(1);
    	OrderTestUtils.assertAllButIdsMatchBetweenOrders(desiredOrder, getCreatedOrder());
    }
